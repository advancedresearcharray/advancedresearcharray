...
Research software, formal verification, and open-source work on AI agent tooling.

## Open source contributions

| Project | Contribution | Status |
|---------|--------------|--------|
| [Postman MCP](https://github.com/postmanlabs/postman-mcp-server) | dotenv/events [#156](https://github.com/postmanlabs/postman-mcp-server/pull/156) [#157](https://github.com/postmanlabs/postman-mcp-server/pull/157); runner stability [#158](https://github.com/postmanlabs/postman-mcp-server/pull/158); nested folders [#159](https://github.com/postmanlabs/postman-mcp-server/pull/159) | Open |
...
- **[researcharray](https://github.com/advancedresearcharray/researcharray)** — `libdimfold`: lossless dimensional folding in C
- **[afld-proof](https://github.com/advancedresearcharray/afld-proof)** — machine-verified properties (Lean 4 / Mathlib)

## Focus

Formal methods · scientific computing · agent memory · MCP · developer tools for AI workflows
